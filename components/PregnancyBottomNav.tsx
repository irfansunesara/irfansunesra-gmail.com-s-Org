...
const PregnancyBottomNav: React.FC = () => {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-sm border-t border-blue-200 shadow-t-lg z-50">
...
export default PregnancyBottomNav;